...
| `bearer`                        |                                                                                           Set this field to 'subaccount' to charge the paystack fee on the subaccount. However, you ensure the amount going to the subaccount is sufficient to pay the fee. This field is optional. Here's the usage: `bearer: "subaccount"`                                                                                              |                                            default: `nill` |
