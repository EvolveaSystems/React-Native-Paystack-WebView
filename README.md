...
| `transaction_charge`                        |                                                                                           Specify a flat fee in kobo that goes into the main account to override the percentage split already specified in the subaccount cofiguration. This field is optional. Here's an example of usage: `transaction_charge: "10000"`                                                                                              |                                            default: `nill` |
| `bearer`                        |                                                                                           Set this field to 'subaccount' to charge the paystack fee on the subaccount. However, you must ensure that the amount going to the subaccount is sufficient to cover the fee. This field is optional. Here's the usage: `bearer: "subaccount"`                                                                                              |                                            default: `nill` |
